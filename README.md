...
A modern, production-ready React application built with TypeScript, Redux Toolkit, Tailwind CSS, and Webpack. Features a complete data table with advanced server-side pagination, search, sorting, and comprehensive API integration.
...
│   │   └── UserData.tsx        # Advanced data table component
│   ├── services/
│   │   └── apis.ts             # API service layer with helpers
│   ├── store/
│   │   ├── index.ts            # Redux store configuration
│   │   └── counterSlice.ts     # Counter slice with actions
│   ├── styles/
...
1. Add new functions to `apiHelpers` in `src/services/apis.ts`
